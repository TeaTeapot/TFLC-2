...
namespace TextEditor
{
    public class Scanner
    {
        ...
        private static readonly Dictionary<string, TokenTypeInfo> TokenTypes = new Dictionary<string, TokenTypeInfo>
        {
        ...
        public (List<Token> Tokens, List<Token> Errors) Scan(string sourceCode)
        {
            ...
            while (_currentPos < _sourceCode.Length)
            {
                ...
                if (token != null)
                {
                    ...
                    token.StartPos = startPos - _lineStartPos;
                ...
                else
                {
                    ...
                    Token errorToken = new Token
                    {
                        ...
                        Line = _currentLine,
                        StartPos = _currentPos - _lineStartPos,
                        EndPos = _currentPos - _lineStartPos
                    };
